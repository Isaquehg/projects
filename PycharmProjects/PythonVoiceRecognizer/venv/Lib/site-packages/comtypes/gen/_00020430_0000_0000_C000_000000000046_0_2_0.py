...
IFontDisp = Font
__all__ = [ 'Unchecked', 'VgaColor', 'OLE_XSIZE_CONTAINER',
           'OLE_YPOS_PIXELS', 'OLE_XSIZE_HIMETRIC',
           'OLE_YSIZE_PIXELS', 'OLE_XPOS_CONTAINER',
           'OLE_ENABLEDEFAULTBOOL', 'Gray', 'FONTITALIC', 'Font',
           'Default', 'IFontEventsDisp', 'FONTNAME',
           'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_PIXELS', 'Monochrome',
           'FONTSTRIKETHROUGH', 'Checked', 'Color', 'FONTBOLD',
           'OLE_YSIZE_CONTAINER', 'Picture', 'IPicture', 'StdPicture',
           'FONTUNDERSCORE', 'OLE_HANDLE', 'OLE_OPTEXCLUSIVE',
           'LoadPictureConstants', 'FontEvents', 'OLE_COLOR',
           'OLE_YPOS_HIMETRIC', 'OLE_CANCELBOOL', 'FONTSIZE',
           'StdFont', 'IPictureDisp', 'OLE_XSIZE_PIXELS', 'IFont',
           'OLE_TRISTATE', 'IFontDisp', 'OLE_XPOS_HIMETRIC',
           'OLE_YPOS_CONTAINER']
